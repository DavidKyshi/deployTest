...
MarketPlaceOfferOverView marketPlaceOfferOverViewFromJson(String str) =>
    MarketPlaceOfferOverView.fromJson(json.decode(str));

String marketPlaceOfferOverViewToJson(MarketPlaceOfferOverView data) =>
...
class MarketPlaceOfferOverView {
  ...
  factory MarketPlaceOfferOverView.fromJson(Map<String, dynamic> json) =>
      MarketPlaceOfferOverView(
