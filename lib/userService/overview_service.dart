...
class OverViewService{
  Future<Map<String, dynamic>> getOverViewOffers(
      {required BuildContext context, required String status, required String baseCurrency, required int daysAgo}) async {
    final token =
  ...
  Future<Map<String, dynamic>> getMarketPlaceOfferOverView(
      {required BuildContext context, required String baseCurrency, required String quoteCurrency, required int daysAgo}) async {
    final token =
        Provider.of<UsersProvider>(context, listen: false).accessToken;
    String baseUrl = dotenv.env['API_URL']!;
  ...
  Future<Map<String, dynamic>> getKyshiConnectOverView(
      {required BuildContext context, required int daysAgo, required  String connectService}) async {
    final token =
        Provider.of<UsersProvider>(context, listen: false).accessToken;
    String baseUrl = dotenv.env['API_URL']!;
