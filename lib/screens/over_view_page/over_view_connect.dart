                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        WalletStatus(color: Color(0xff2668EC), text: 'NGN',),
                        SizedBox(height: 10,),
                        WalletStatus(color: primaryColor, text: 'GBP',),
                        SizedBox(height: 10,),
                        WalletStatus(color: Color(0xff6E80A3), text: 'USD',),
                        SizedBox(height: 10,),
                        WalletStatus(color: Color(0xff4DAEF8), text: 'CAD',)
                      ],
                    )
                  ],
                ),
