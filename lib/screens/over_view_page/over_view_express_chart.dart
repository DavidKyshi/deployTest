               ...
               Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            children: [
                              WalletStatus2(color: Color(0xff23CE6B), text: 'GBP',),
                              WalletStatus2(color: primaryColor, text: 'USD',),
                              WalletStatus2(color: Color(0xff4DAEF8), text: 'CAD',),
                            ],
                          )
                        ],
                      ),
                    ),
                    boxy2("Total GBP ","£ 0.00","Total USD","\$0.00", "Total  CAD","C\$ 0.00")
            ],
          )
        ],
      ),
