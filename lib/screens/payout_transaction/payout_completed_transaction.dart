...
class PayOutCompletedTransactionTable extends StatefulWidget {
  ...
  @override
  State<PayOutCompletedTransactionTable> createState() => _PayOutCompletedTransactionTableState();
}

class _PayOutCompletedTransactionTableState extends State<PayOutCompletedTransactionTable> {
                            ...
                            AllOfferTitleTable( 
                             ...
                             name: SizedBox(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                StatusText(text: 'COMPLETED', isCompleted: true, isPending: false,),
                                 SizedBox(height: 45,),
                                StatusText(text: 'COMPLETED', isCompleted: true, isPending: false,),
                                  SizedBox(height: 45,),
                                  StatusText(text: 'COMPLETED', isCompleted: true, isPending: false,),
                             ...
                             name: SizedBox(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                               children: [
                                 OfferButton(isBorder: true, text: 'RETRY', ),
                                 SizedBox(height: 35,),
                                 InkWell(
                                  onTap: (){
                                  ...
                                  child: OfferButton(isBorder: true, text: 'RETRY', )),
                                  SizedBox(height: 35,),
                                 OfferButton(isBorder: true, text: 'RETRY', ),
                               ],
                              )
