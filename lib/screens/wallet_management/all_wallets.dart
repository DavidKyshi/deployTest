...
class _AllWalletsState extends State<AllWallets> {
  ...
  final List<String> date = ["Active","Rejected","Pending",];
    ...
    final List<Widget> id = [
      Transform.scale(
        ...
        child: CupertinoSwitch(
            ...
            value: activeWalletSwitchValue, onChanged: (value){
          setState(() {
      ...
      Transform.scale(
        ...
        child: CupertinoSwitch(
            ...
            value: pendingWalletSwitchValue, onChanged: (value){
          setState(() {
      ...
      Transform.scale(
        ...
        child: CupertinoSwitch(
            ...
            value: rejectedWalletSwitchValue, onChanged: (value){
          setState(() {
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(width: 20,),
                                       Padding(
                                        ...
                                        child: Text("wallet balance",style: TextStyle(color:
                                        primaryColor.withOpacity(0.5),fontFamily: 'PushPenny',fontSize: 12,fontWeight: FontWeight.w500),),
                                      ),
                                      const SizedBox(width: 20,),
                                      AllOfferTitleTable(
                                        title: 'Total',
                                              ...
                                              children: [
                                                InkWell(
                                                  onTap: (){
                                                    ...
                                                    child: OfferButton(isBorder: false, text: 'ADD COMMENT', comment: true,commentBackground: false,)),
                                                ...
                                                InkWell(
                                                    ...
                                                    child: OfferButton(isBorder: false, text: 'VIEW COMMENT',comment: true, )),
                                                SizedBox(height: 35,),
                                                OfferButton(isBorder: false, text: 'VIEW COMMENT',comment: true, ),
                                              ],
                                            )
                                        ),
                                      ),
