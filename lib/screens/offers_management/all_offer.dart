                  ...
                  child: Padding(
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          Text('We currently don’t have any offer at \n the Kyshi marketplace,  it will \n appear here when we do',
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      children: [
                                        Text(
                                          convertDateTime(offersData[index].createdAt.toString()),
                                          style: TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400,
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      children: [
                                        Text(
                                          offersData[index].quoteCurrency ?? "",
                                        ),
                                        SizedBox(
                                          height: 40,
                                        )
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      children: [
                                        Text(
                                          offersData[index].quoteFee.toString(),
                                        ),
                                        SizedBox(
                                          height: 40,
                                        )
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      children: [
                                         Text(
                                          convertDateTime(offersData[index].expiresAt.toString()),
                                          style: TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400,
                                              color: Color(0xff233375)),
