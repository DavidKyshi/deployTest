              ...
              child:  Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("View comment",style: TextStyle(
                          color: primaryColor,
                        fontWeight: FontWeight.w700,
                        fontSize: 28,
                        fontFamily: 'PushPenny'
                  ...
                  Container(
                    ...
                    child: Text("Could not validate all credentials, possibly fraud"),
                  ),
                ],
              )),
...
manageWalletStatusAlertBox(BuildContext context){
  ...
  final TextEditingController controller = TextEditingController(text: "Pending");
  return showDialog(
      context: context,
      builder: (BuildContext context){
                  ...
                  children: [
                   ...
                   KyshiTextfieldWithLabel(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        KyshiButtonResponsive(color: Colors.white, onPressed: (){},text: "Cancel",childTextStyle: TextStyle(color: primaryColor),size: 180,radius: 23,),
                        KyshiButtonResponsive(color: primaryColor, onPressed: (){},text: "Save",size: 180,radius: 23,)
                      ],
                    )
